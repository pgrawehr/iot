...
{
    [ArduinoReplacement(typeof(System.Buffer), true, IncludingPrivates = true, TargetFramework = TargetFramework.Nano)]
    internal static class MiniBuffer2
    {
        ...
        [ArduinoImplementation]
        public static void Memmove<T>(ref T destination, ref T source, UIntPtr elementCount)
        {
