...
<<<<<<< HEAD
        ...
        public static void Main(string[] args)
        {
            ...
            var i2cSettings = new I2cConnectionSettings(busId, Bmp280.SecondaryI2cAddress);
            var i2cDevice = I2cDevice.Create(i2cSettings);
            var i2CBmp280 = new Bmp280(i2cDevice);

            using (i2CBmp280)
            {
                i2CBmp280.SetPowerMode(Bmx280PowerMode.Normal);
                while (true)
                {
                    // set higher sampling
                    i2CBmp280.TemperatureSampling = Sampling.HighResolution;
                    i2CBmp280.PressureSampling = Sampling.HighResolution;
