...
", _sb.ToString());
        ...
        public void NewImplementation()
        {
            ...
            Assert.Equal(@"$ECRPM,E,1,0,0,A*50
$PCDIN,01F200,00002710,00,000000FFFF00FFFF*21
$PCDIN,01F201,00002710,00,000000FFFFE7720005000018150000FFFF000000010000007F7F*5E
", _sb.ToString());
            ...
            Assert.Equal(@"$ECRPM,E,1,3600,100,A*64
$PCDIN,01F200,00002AF8,00,00003CFFFF64FFFF*5A
$PCDIN,01F201,00002AF8,00,000000FFFF477C0005000018150000FFFF000000000000007F7F*56
", _sb.ToString());
        }
