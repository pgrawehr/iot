...
namespace Iot.Device.Nmea0183
{
    ...
    public sealed class AutopilotController : IDisposable
    {
        ...
        internal void CalculateNewStatus(int loops, DateTimeOffset now)
        {
            ...
            if (_cache.TryGetCurrentPosition(out var position, TalkerId.GlobalPositioningSystem, false, out Angle track, out Speed sog, out Angle? heading, out _) && position != null)
            {
