...
namespace System.Device.Gpio
{
    ...
    public abstract class GpioDriver : IDisposable
    {
        ...
        protected internal virtual AlternatePinMode GetAlternatePinMode(int logicalPinNumber)
        {
        ...
        protected internal virtual void SetAlternatePinMode(int logicalPinNumber, AlternatePinMode altMode)
        {
            // Virtual instead of abstract, so as not to be breaking.
            throw new NotSupportedException("This driver does not support alternate modes");
        }
