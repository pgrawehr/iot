...
/// <summary>
/// An abstract GPIO driver for the Raspberry Pi 3 or 4, running Raspbian (or, with some limitations, ubuntu)
/// </summary>
public abstract unsafe class RaspberryPiDriver : GpioDriver
{
    ...
    /// <summary>
    /// Constructs an instance of this abstract driver.
    /// </summary>
    protected RaspberryPiDriver()
    {
    ...
    public RaspberryPiDriver(RaspberryBoardInfo? boardInfo)
        : this()
    {
